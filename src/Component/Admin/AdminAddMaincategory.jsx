...
import {addMaincategory, getMaincategory} from "../../Store/ActionCreatore/MaincategoryActionCreatore"
                    ...
                    <div className="col-lg-10">
                        ...
                        <form onSubmit={postData} className='p-3'>
                            <div className="mb-3">
                                ...
                                <input type="text" name='name' id="name" onChange={getData} className='form-control' placeholder='Enter Maincategory name' required/>
                            </div>
                            <div className="mb-3">
