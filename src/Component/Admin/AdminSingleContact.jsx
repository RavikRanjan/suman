...
import { deleteContact, getContact, updateContact } from "../../Store/ActionCreatore/ContactActionCreatore"
                ...
                <div className="row">
                    ...
                    <div className="col-lg-10">
                        ...
                        <div className='w-100 p-3 border'>
                            {
                                data.status === "Active" ?
                                    <button className='btn btn-success rounded-0 w-100' onClick={update}>Update Status to Done</button>:
                                <button className='btn btn-success rounded-0 w-100' onClick={deleteRecord}>Delete</button>
                            }
                        </div>
                    </div>
                </div>
