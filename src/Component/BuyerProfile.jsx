...
export default function BuyerProfile({ user }){
  return (
    <>
         <h5 className='text-center bg-secondary p-2 rounded'>Buyer Profile</h5>
            ...
            <div className='d-flex'>
              <div className="first p-2 border w-50">Email Address</div>
            ...
            <div>
              <Link to="/update-profile" className='btn mt-3 p-2 btn-secondary w-100'>Update Profile</Link>
            </div>
    </>
  )
}
